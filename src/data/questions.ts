import { react, js, html, python, cplusplus, java } from './index'
...
export const questions: Questions = {
  ...
  JAVASCRIPT: {
    technologyName: Technologies.javascript,
    imageSrc: js,
    questions: [
      {
  ...
  HTML: {
    technologyName: Technologies.html,
    imageSrc: html,
    questions: [
      {
      ...
      {
        question: "Waht is the output of this code ? <div class='sum'>(3+6)/2</div>",
        options: ['4', '(3+6)/2', '4.5', '6'],
        correctOption: 1,
      },
      {
        question: 'HTML elements are divided into two categories: block level and inline elements.',
        options: ['false', 'true'],
        correctOption: 1,
      },
      {
        question: 'The navigation menu of a webpage can only be placed in the <nav> tag.',
        options: ['false', 'true'],
        correctOption: 0,
      },
      {
  ...
  PYTHON: {
    technologyName: Technologies.python,
    imageSrc: python,
    questions: [
      {
      ...
      {
        question: 'Waht is the output of this code ? var = "70.0"; print(int(var))',
        options: ['Error', "'70px'", '70', '70.0'],
        correctOption: 0,
      },
      {
      ...
      {
        question: "What is the output of this code ? a = 'a'; print(type(a))",
        options: ["<class 'varchar'>", "<class 'string'>", "<class 'str'>", "<class 'char'>"],
        correctOption: 2,
      },
    ],
  },
  CPLUSPLUS: {
    technologyName: Technologies.cplusplus,
    imageSrc: cplusplus,
    questions: [
      {
      ...
      {
        question: 'WThe value of a string variable can be surrounded by single quotes.',
        options: ['True', 'False'],
        correctOption: 1,
      },
      {
  ...
  JAVA: {
    technologyName: Technologies.java,
    imageSrc: java,
    questions: [
      {
        question: 'Which data type is used to create a variable that should store text ?',
